...
<title>Perfil de <?php echo $dadosUser1['nome'];?></title>
            ...
            <div class="col-md-3">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="w3-center"><img src="img/<?php echo ($dadosUser1['foto'] == '') ? 'default.jpg' : $dadosUser1['foto'];?>" class="w3-circle" style="height:106px;width:106px;border-radius:50%" alt="Avatar"></p>
                        <hr>
              ...
              <?php } else {?>
                <div class="w3-row w3-opacity">
                    <div class="w3-half">
                    <div class="card-body">
                    <span onclick="this.parentElement.style.display='none'" class="btn-close">
                    <i class="fa fa-remove"></i>
                    </span>
                    <p><strong>Viajante!</strong></p>
                    <p>Você já conhece esse usuário ou está no seu próprio perfil.</p>
                    </div>
                    </div>
                    </div>
                    <div class="w3-half">
        ...
        <br><div class="card gedf-card">
                    <div class="card-header">
                        <div class="d-flex justify-content-between align-items-center">
                            <div class="d-flex justify-content-between align-items-center">
                                <div class="mr-2">
                                    <img width="45" style="border-radius:50%" src="img/<?php echo ($dadosUser1['foto'] == '') ? 'default.jpg' : $dadosUser1['foto'];?>"" alt="">
                                </div>
                                <div class="ml-2">
                                    <div class="h5 m-0"><?php echo $dadosUser1['nome'];?></div>
                                </div>
                            </div>
                        </div>
